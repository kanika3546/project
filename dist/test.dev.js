...
var brands = _toConsumableArray(new Set(_toConsumableArray(products.map(function (p) {
  return p.brand;
}))));

console.log(_toConsumableArray(new Set(_toConsumableArray(products.map(function (p) {
  return p.brand;
})))));
brands.map(function (c) {
  return {
    value: c,
    label: c.split('').join(' '),
    checked: false
...
console.log(brands.map(function (c) {
  return {
    value: c,
    label: c.split('').join(' '),
    checked: false
